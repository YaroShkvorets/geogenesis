...
export function EditableEntityPage({ id, name: serverName, space }: Props) {
  const { triples, schemaTriples, update, create, remove, hideSchema, hiddenSchemaIds } = useEntityStore();
